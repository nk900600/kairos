											...
											<div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
												...
												<div style="display:flex">
													...
													<div>
														...
														<div>
															<!--begin::Title-->
															<a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Add Menu</a>
															<!--end::Title-->
															<!--begin::Desc-->
												...
												<div style="display:flex">
													...
													<div>
														...
														<div>
															<!--begin::Title-->
															<a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Add Table</a>
															<!--end::Title-->
															<!--begin::Desc-->
												...
												<div style="display:flex">
													...
													<div>
														...
														<div>
															<!--begin::Title-->
															<a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Add Employee</a>
															<!--end::Title-->
															<!--begin::Desc-->
